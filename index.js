...
async function get_kc_act() {
	...
	//console.log("Access Token:", access_keys.access_token);
	//console.log("Refresh Token:", access_keys.refresh_token);
...
async function check_token_expiration() {
    ...
    const exp_access = decodedAccessToken.payload.exp;
    const exp_refresh = decodedRefreshToken.payload.exp;
